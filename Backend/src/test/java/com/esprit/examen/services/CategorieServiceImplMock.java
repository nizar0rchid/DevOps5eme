...
public class CategorieServiceImplMock {
    ...
    public void saveCategorieTest() {
        CategorieProduit cat = new CategorieProduit(null, "cat1", "categorie 1", null);
    ...
    public void getUsersTest() {
        Mockito.when(categorieProduitRepository.findAll()).thenReturn(Stream
                .of(new CategorieProduit(null,"cat2", "categorie 2",null), new CategorieProduit(null,"cat2", "categorie 3",null)).collect(Collectors.toList()));
    ...
    public void deleteUserTest() {
        CategorieProduit cat = new CategorieProduit(null, "cat4", "categorie 4", null);
